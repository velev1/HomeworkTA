...
namespace Matrixes
{
    ...
    public class Matrix<T>
    {
        ...
        public static Matrix<T> operator +(Matrix<T> m1, Matrix<T> m2)
        {
            ...
            {
                throw new ArgumentException("Matrices must have equal dimentions");
            }

            var result = new Matrix<T>(m1.matrix.GetLength(0),
               m1.matrix.GetLength(1));
        ...
        public static Matrix<T> operator *(Matrix<T> m1, Matrix<T> m2)
        {
            ...
            {
                throw new ArgumentException("Matrices must have equal row and col");
            }


            var result = new Matrix<T>(m1.matrix.GetLength(0),
               m2.matrix.GetLength(1));
